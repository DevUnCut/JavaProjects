...
public class FxInital extends Application 
{
	public void start(Stage stage) 
	{
		...
		Button frustrationButton = new Button("For stresss");
		frustrationButton.setOnAction(e -> message.setText("Relax!!"));
		Button quitButton = new Button("Quit");
		quitButton.setOnAction(e -> Platform.exit());
		HBox buttonBar = new HBox(20, helloButton, goodbyeButton,frustrationButton, quitButton);
